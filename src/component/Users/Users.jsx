...
const Users = () => {
    ...
    return (
        <div className="">
          ...
          {users.map(user => <div key={user._id} className="p-6 mb-6 shadow-2xl rounded-xl sm:p-12 dark:bg-gray-50 dark:text-gray-800">
            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
                <img src={user?.image || "https://source.unsplash.com/75x75/?portrait"} alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-300" />
                <div className="flex flex-col">
                    <h4 className="text-lg font-semibold text-center md:text-left">{user.username}</h4>
                    <p className="dark:text-gray-600 text-center">{user.email}</p>
                </div>
            </div>
